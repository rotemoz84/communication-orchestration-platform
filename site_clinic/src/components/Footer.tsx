                ...
                <div className="footer-grid">
                    <div className="footer-brand">
                        ...
                        <p className="text-sm font-medium leading-relaxed max-w-xs">
                            מומחה לרפואת נשים, פריון והריון. מומחה לאולטרסאונד גניקולוגי ומיילדותי.
                        </p>
                        <p className="text-sm font-medium leading-relaxed max-w-xs">
מקצועיות ללא פשרות לצד יחס אישי ואנושי.                        
</p>
                    </div>
